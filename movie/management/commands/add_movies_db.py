...
class Command(BaseCommand):
    help = "Load movies from movie_descriptions.json into the Movies model"
    ...
    def handle(self, *args, **kwargs):
        ...
        for i in range(100):
            ...
            if not exist:
                Movie.objects.create(title=movie['title'], image = 'movie/images/default.jpg', genre=movie['genre'],year=movie['year'], description=movie['plot'],)